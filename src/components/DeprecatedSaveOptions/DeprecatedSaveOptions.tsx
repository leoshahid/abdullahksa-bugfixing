...
function SaveOptions() {
  ...
  const isLayerContextActive =
    layerContext.createLayerformStage === "thirdStep";
  ...
  const { saveResponse, isError } = isLayerContextActive
    ? layerContext
    : catalogContext;
      ...
      {!!saveResponse ? (
        ...
        <>
          ...
          <div className="flex justify-start items-start w-full mb-4">
            <label
              className={
                styles.optionLabel + "flex justify-center items-center"
              }
            >
              <input
                type="radio"
          ...
          <div className="flex justify-start items-start w-full mb-4">
            ...
            >
              ...
              <span className={styles.optionText}>
                Save full on s-loc. We create storage account for you, you still
                own the data
              </span>
            </label>
          </div>
